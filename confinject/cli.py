...
if not CWD.joinpath('.vscode/settings.json').is_file():
    ...
    shutil.copy(TEMPLATE_DIR.joinpath('.vscode/settings.json'), CWD.joinpath('.vscode/settings.json'))
else:
...
if not CWD.joinpath('.vscode/extensions.json').is_file():
    ...
    shutil.copy(TEMPLATE_DIR.joinpath('.vscode/extensions.json'), CWD.joinpath('.vscode/extensions.json'))
else:
